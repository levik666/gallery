...
Imagevue X2.8.4 - Oct 1, 2012

Renamed jquery.cookie.js to prevent issues on some servers
Now you can Zoom images in Mobile version
Custom Mobile 'Add to Home Page' text
CSS classes on config tabs
Improved Video Thumbnail Creation
FFMPEG creates video thumbnail from 3 sec offset


Imagevue X2.8.3.1 - Aug 31, 2012

Fixes issues with mobile menu
Fixed issues with sharing from HTML gallery


Imagevue X2.8.3 - Aug 29, 2012

Settings/Seo/HTML Redirect to Flash if flash installed
Lightbox links are opened in a new window on Mobile
Fix for admin link when hosted on Windows servers
FFMPEG support for video thumbnails creation
PHP5.4 Compatibility
<br> converted to newlines in HTML image titles
Ability to rename users in admin
Fixed clunky mobile scrolling
_preview.jpg can be used for hidden folder previews


Imagevue X2.8.2 - Aug 2, 2012

Added retina social mobile icons for footer
Fixed negative loading bare issue
Fixed audio player restart after video lightbox close.
Fix issue with menu shadow if autohide = false
